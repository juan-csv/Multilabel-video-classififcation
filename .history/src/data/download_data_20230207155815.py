...
if __name__ == '__main__':
    ...
    if FRAME_LEVEL is False:
        ...
        cmd = f"curl data.yt8m.org/download.py | partition=2/video/train mirror=us python"
        os.system(cmd)
        print("Finishing training data\n--------------------------------------------------------")

        print("Dowloading validation data ...")
        cmd = f"curl data.yt8m.org/download.py | partition=2/video/validate mirror=us python"
        os.system(cmd)
        print("Finishing validation data\n--------------------------------------------------------")
        
        print("Downloading testing data ...")
        cmd = f"curl data.yt8m.org/download.py | partition=2/video/test mirror=us python"
        os.system(cmd)
