...
class YoutubeVideoDataset(IterableDataset):
    def __init__(self, file_paths, seed=939, debug=False,
        ...
        self.N_CLASSES = len( vocab['Index'].unique() )
        self.epochs = epochs
        self.offset = offset
...
dataset = YoutubeVideoDataset(list_train_files, epochs=None)
loader = DataLoader(dataset, num_workers=4, batch_size=32, collate_fn=collate_videos)
max_class = 0
